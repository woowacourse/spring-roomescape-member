...
- [x]  지나간 날짜로 예약하면 예외가 발생한다 -> `PAST_DATE_RESERVATION` (422)
...
- [x]  필수값 누락 및 잘못된 형식의 요청이 오는 경우 예외가 발생한다 -> `VALIDATION_FAILED` (400)
...
- [x]  존재하지 않는 이름으로 조회하면 빈 목록을 반환한다.
