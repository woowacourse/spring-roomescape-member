...
| HC3 | 서버 오류인 경우                           | 500 Internal Server Error | 예상치 못한 오류가 발생했습니다. |
...
| ID  | 상황                  | HTTP Code                 | 상위 에러 메시지          |
|-----|---------------------|---------------------------|--------------------|
| HD1 | 요청 처리 성공            | 200 OK                    | 없음                 |
| HD2 | id의 자료형이 올바르지 않은 경우 | 400 Bad Request           | 요청값이 올바르지 않습니다.    |
| HD3 | 서버 오류인 경우           | 500 Internal Server Error | 예상치 못한 오류가 발생했습니다. |
