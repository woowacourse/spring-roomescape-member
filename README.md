...
- [ ] `/login` 요청 시 로그인 페이지를 응답한다.

### 사용자 인증 정보 조회

- [ ] `/login/check` 요청 시 사용자 인증 정보를 응답한다.

### 사용자 로그아웃

- [ ] 사용자는 로그아웃 할 수 있다.
- [ ] `/logout` 요청 시 만료 Token을 응답한다.

### 사용자 회원가입

- [ ] 사용자는 이메일, 비밀번호, 이름으로 회원가입 할 수 있다.
- [ ] `/signup` 요청 시 로그인 페이지를 응답한다.
- [ ] `/members` 요청 시 사용자 정보를 저장한다.
