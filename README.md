...
| ID    | 상황                  | 문제 파라미터명 | 파라미터 에러 메시지       |
|-------|---------------------|----------|-------------------|
| RD2-1 | id의 자료형이 올바르지 않은 경우 | id       | id의 값이 유효하지 않습니다. |
| RD2-2 | id의 값이 양수가 아닌 경우    | id       | id의 값은 양수여야 합니다.  |
...
| TC3 | 서버 오류인 경우                           | 500 Internal Server Error | 예상치 못한 오류가 발생했습니다. |
...
| ID  | 상황                  | HTTP Code                 | 상위 에러 메시지          |
|-----|---------------------|---------------------------|--------------------|
| TD1 | 요청 처리 성공            | 200 OK                    | 없음                 |
| TD2 | id의 자료형이 올바르지 않은 경우 | 400 Bad Request           | 요청값이 올바르지 않습니다.    |
| TD3 | 서버 오류인 경우           | 500 Internal Server Error | 예상치 못한 오류가 발생했습니다. |

### 파라미터별 에러 메시지

| ID    | 상황                  | 문제 파라미터명 | 파라미터 에러 메시지       |
|-------|---------------------|----------|-------------------|
| TD2-1 | id의 자료형이 올바르지 않은 경우 | id       | id의 값이 유효하지 않습니다. |
...
| ID    | 상황                  | 문제 파라미터명 | 파라미터 에러 메시지       |
|-------|---------------------|----------|-------------------|
| HD2-1 | id의 자료형이 올바르지 않은 경우 | id       | id의 값이 유효하지 않습니다. |
