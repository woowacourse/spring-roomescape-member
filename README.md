...
| 테마 추가        | `POST /admin/themes`                      | `{name, description, thumbnail_url}` | `{id, name, description, thumbnail_url, rumtime}`                                                     |
...
| 테마 조회        | `GET /themes/popular`                     |                                      | `[{id, name, description, thumbnail_url, rumtime}, ...]`                                              |
| 인기 있는 테마 조회  | `GET /themes?days={}&limit={}`            |                                      | `[{id, name, description, thumbnail_url, rumtime}, ...]`                                              |
