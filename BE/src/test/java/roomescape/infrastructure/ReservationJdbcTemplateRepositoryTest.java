...
//
////    @Test
////    @DisplayName("date, themeId 모두 null이면 전체 예약 목록을 조회한다.")
...
////
////        // when
////        List<Reservation> result = reservationRepository.findByDateAndThemeId(null, null);
////
////        // then
...
//
//        // when
//        boolean exists = reservationRepository.existById(savedTime1.id());
//        boolean notExists = reservationRepository.existById(999L);
//
//        // then
...
//
//        // then
//        Optional<Reservation> deleteTargetFindResult = reservationRepository.findByDateAndThemeId(null, null)
//                .stream()
