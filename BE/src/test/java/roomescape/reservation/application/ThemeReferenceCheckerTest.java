...
class ThemeReferenceCheckerTest {

    private ReservationRepository reservationRepository;
    private ThemeReferenceChecker referenceChecker;
    ...
    void validateThemeNotReferenced_success() {
        // when & then
        assertThatCode(() -> referenceChecker.validateThemeNotReferenced(1L))
    ...
    void validateThemeNotReferenced_fail_with_referenced_theme() {
        ...
        // when & then
        assertThatThrownBy(() -> referenceChecker.validateThemeNotReferenced(theme.getId()))
