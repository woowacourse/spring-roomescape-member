...
public class InitialDataFixture {
    ...
    public static final Reservation RESERVATION_1 = new Reservation(1L, new Name("브라운"), LocalDate.parse("2024-04-25"),
            RESERVATION_TIME_1, THEME_1);
    public static final Reservation RESERVATION_2 = new Reservation(2L, new Name("솔라"), LocalDate.parse("2099-05-01"),
            RESERVATION_TIME_1, THEME_1);
}
