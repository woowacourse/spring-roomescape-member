...
class ReservationTest {
    ...
    void isDuplicated() {
        ...
        Reservation reservation1 = Reservation.of(1L, MEMBER1, THEME_1, date, reservationTime);

        // when
        Reservation reservation2 = Reservation.of(2L, MEMBER2, THEME_1, date, reservationTime);
    ...
    void isNotduplicated(String date, String time, Long timeId) {
        ...
        Reservation reservation1 = Reservation.of(1L, MEMBER1, THEME_1, date1, time1);

        // when
        LocalDate date2 = LocalDate.parse(date);
        ReservationTime time2 = ReservationTime.of(timeId, LocalTime.parse(time));
        Reservation reservation2 = Reservation.of(2L, MEMBER2, THEME_1, date2, time2);
        boolean duplicated = reservation2.isDuplicated(reservation1);
