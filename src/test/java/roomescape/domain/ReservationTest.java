...
class ReservationTest {
    ...
    void 예약자명은_2글자_이상_5글자_이하만_가능하다_성공() {
        assertThatCode(() -> new Reservation(1L, "가나다", LocalDate.now(), new ReservationTime(1L, LocalTime.of(12, 0)),
    ...
    void 예약자명은_2글자_이상_5글자_이하만_가능하다_실패(String name) {
        assertThatThrownBy(
                () -> new Reservation(1L, name, LocalDate.now(), new ReservationTime(1L, LocalTime.of(12, 0)),
                        new Theme(1L, "name", "description", "thumbnail")))
