...
class ReservationTest {
    ...
    void 지난_날짜에_대한_예약이라면_예외가_발생한다(LocalDateTime currentDateTime, LocalDateTime reservationDateTime) {
        assertThatThrownBy(() -> new Reservation("test", currentDateTime, reservationDateTime.toLocalDate(), new ReservationTime(1L, reservationDateTime.toLocalTime()), new Theme(1L, "name", "description", "thumbnail")))
                .isInstanceOf(IllegalArgumentException.class)
