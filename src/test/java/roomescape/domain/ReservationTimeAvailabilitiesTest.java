...
class ReservationTimeAvailabilitiesTest {
    ...
    void checkIsAlreadyBookedTest() {
        ...
        final List<Reservation> reservations = List.of(
                Reservation.ofSavedReservation(1L, "켈리", date, reservationTime1, theme),
                Reservation.ofSavedReservation(2L, "켈리", date, reservationTime2, theme),
                Reservation.ofSavedReservation(3L, "켈리", date, reservationTime3, theme)
        );
