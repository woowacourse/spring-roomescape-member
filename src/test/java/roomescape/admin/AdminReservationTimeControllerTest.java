...
class AdminReservationTimeControllerTest {
    ...
    void 예약시간_추가() throws Exception {
        ...
        given(reservationTimeService.create(any()))
                .willReturn(new ReservationTimeResponse(6L, LocalTime.of(20, 0)));
    ...
    void 예약시간_삭제() throws Exception {
        willDoNothing().given(reservationTimeService).delete(6L);

        mockMvc.perform(delete("/admin/times/6"))
    ...
    void 존재하지_않는_예약시간_삭제시_404() throws Exception {
        willThrow(new RoomescapeException(ErrorReason.RESERVATION_TIME_NOT_FOUND))
