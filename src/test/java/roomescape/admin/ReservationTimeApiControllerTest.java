...
class ReservationTimeApiControllerTest extends BaseControllerUnitTest {
    ...
    @MethodSource("roomescape.admin.fixture.ReservationTimeApiRequestFixture#registerFailRequestFixture")
