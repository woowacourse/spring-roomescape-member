...
class ReservationRowMapperTest {
    ...
    void return_reservation_by_map_row() throws SQLException {
        ...
        resultSet.addRow(1, 1, "재즈", "admin", "email", "password", 1, "재즈의 프로그래밍 모험", "설명", "hi.jpg", "2024-04-24", 1,
                "20:00");
        resultSet.next();
        ...
        assertAll(
                ...
                () -> assertThat(reservation.getMember().getRole()).isEqualTo("admin"),
                () -> assertThat(reservation.getMember().getEmail()).isEqualTo("email"),
                () -> assertThat(reservation.getMember().getPassword()).isEqualTo("password"),
