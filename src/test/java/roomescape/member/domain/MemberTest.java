...
class MemberTest {
    ...
    void validateNameFailTest(String name) {
        assertThatThrownBy(() -> {
            new Member(1L, name, "abcd@gmail.com", "2580", MemberRole.USER);
    ...
    void invalidEmailTest() {
        assertThatThrownBy(() -> new Member(1L, "name", "asd%google.com", "2580", MemberRole.USER))
                .isInstanceOf(CustomException.class);
    }
    ...
    @Test
    void validEmailTest() {
        assertThatCode(() -> new Member(1L, "name", "asd@google.com", "2580", MemberRole.USER))
                .doesNotThrowAnyException();
    }
}
