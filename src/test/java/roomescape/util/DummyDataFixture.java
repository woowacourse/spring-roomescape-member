...
public class DummyDataFixture {
    ...
    private List<Reservation> preparedReservations = List.of(
            new Reservation(1L, "아서", LocalDate.parse("2024-04-23"),
                    getReservationTimeById(1L), getThemeById(1L)),
            new Reservation(2L, "몰리", LocalDate.parse("2024-04-24"),
                    getReservationTimeById(2L), getThemeById(1L)),
            new Reservation(3L, "마크", LocalDate.parse("2024-04-25"),
                    getReservationTimeById(3L), getThemeById(1L)),
            new Reservation(4L, "비밥", LocalDate.parse("2024-04-26"),
                    getReservationTimeById(4L), getThemeById(1L)),
            new Reservation(5L, "러너덕", LocalDate.parse("2024-04-27"),
                    getReservationTimeById(5L), getThemeById(2L)),
            new Reservation(6L, "현구막", LocalDate.parse("2024-04-28"),
                    getReservationTimeById(1L), getThemeById(2L)),
            new Reservation(7L, "찰리", LocalDate.parse("2024-04-29"),
                    getReservationTimeById(2L), getThemeById(2L)),
            new Reservation(8L, "네오", LocalDate.parse("2024-04-30"),
                    getReservationTimeById(3L), getThemeById(3L)),
            new Reservation(9L, "포비", LocalDate.parse("2024-05-01"),
                    getReservationTimeById(4L), getThemeById(3L)),
            new Reservation(10L, "솔라", LocalDate.parse("2024-05-02"),
                    getReservationTimeById(5L), getThemeById(4L)),
            new Reservation(11L, "브리", LocalDate.parse("2024-05-03"),
                    getReservationTimeById(1L), getThemeById(4L)),
            new Reservation(12L, "리사", LocalDate.parse("2024-05-04"),
                    getReservationTimeById(2L), getThemeById(5L)),
            new Reservation(13L, "왼손", LocalDate.parse("2024-05-05"),
