...
class AvailabilityOfTimeRequestTest {
    ...
    void throw_exception_when_null_theme_id_input() {
        assertThatThrownBy(() -> new AvailabilityOfTimeRequest(validDate, null))
    ...
    void throw_exception_when_not_natural_theme_id_input(Long themeId) {
        assertThatThrownBy(() -> new AvailabilityOfTimeRequest(validDate, themeId))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void throw_exception_when_null_date_input(String date) {
        assertThatThrownBy(() -> new AvailabilityOfTimeRequest(date, validThemeId))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void create_success() {
        assertThatNoException()
                .isThrownBy(() -> new AvailabilityOfTimeRequest(validDate, validThemeId));
    }
}
