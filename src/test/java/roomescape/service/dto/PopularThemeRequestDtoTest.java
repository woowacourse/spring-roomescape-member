...
class PopularThemeRequestDtoTest {
    ...
    void throw_exception_when_null_theme_count_input() {
        PopularThemeRequestDto requestDto = new PopularThemeRequestDto(validStartDate, validEndDate, null);
    ...
    void throw_exception_when_not_natural_theme_count_input(Integer themeCount) {
        PopularThemeRequestDto requestDto = new PopularThemeRequestDto(validStartDate, validEndDate, themeCount);
    ...
    void throw_exception_when_invalid_date_format_input(String date) {
        PopularThemeRequestDto requestDto = new PopularThemeRequestDto(validStartDate, date, validThemeCount);
    ...
    @Test
    void create_success() {
        PopularThemeRequestDto requestDto = new PopularThemeRequestDto(validStartDate, validEndDate, validThemeCount);
