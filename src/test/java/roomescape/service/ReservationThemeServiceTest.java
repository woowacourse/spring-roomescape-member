...
public class ReservationThemeServiceTest {
    ...
    @Autowired
    ReservationThemeService service;
    ...
    void removeReservationThemeWithExistsReservation() {
        ...
        // when & then
        assertThatThrownBy(() -> service.removeReservationTheme(existId)).isInstanceOf(
    ...
    void removeReservationTheme() {
        ...
        //when & then
        assertThatThrownBy(() -> service.removeReservationTheme(notExistId)).isInstanceOf(DataNotFoundException.class)
