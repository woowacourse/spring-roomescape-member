...
public class ReservationServiceTest {
    ...
    void addReservation() {
        ReservationRequest request = new ReservationRequest(LocalDate.of(2025, 4, 26), "사나", 1L);
        ReservationResponse actual = reservationService.addReservation(request);

        assertAll(() -> {
            assertThat(actual.id()).isEqualTo(1L);
            assertThat(actual.name()).isEqualTo("사나");
            assertThat(actual.date()).isEqualTo(LocalDate.of(2025, 4, 26));
    ...
    void findAllReservations() {
        ReservationRequest request1 = new ReservationRequest(LocalDate.of(2025, 4, 26), "사나", 1L);
        ReservationRequest request2 = new ReservationRequest(LocalDate.of(2025, 4, 28), "앤지", 1L);
