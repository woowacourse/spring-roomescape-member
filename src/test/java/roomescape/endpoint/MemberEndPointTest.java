...
public class MemberEndPointTest {
    ...
    @DisplayName("멤버 목록을 조회하면 상태 코드 200과 테마 목록을 응답으로 반환한다.")
    @Test
    void getMembers() {
    ...
    @DisplayName("멤버를 추가하면 상태 코드 201와 추가된 객체를 반환한다.")
    @Test
    void addMember() {
    ...
    @DisplayName("멤버를 삭제하면 상태 코드 204를 반환한다.")
    @Test
    void deleteMember() {
    ...
    @DisplayName("예약이 존재하는 멤버를 삭제하면 상태 코드 400을 반환한다.")
    @Test
