...
public class Fixtures {
    ...
    public static final Reservation JUNK_RESERVATION_1 = new Reservation(1L, "예약1", LocalDate.of(2025, 5, 4), JUNK_TIME_SLOT_1, JUNK_THEME_2);
    public static final Reservation JUNK_RESERVATION_2 = new Reservation(2L, "예약2", LocalDate.of(2025, 5, 4), JUNK_TIME_SLOT_2, JUNK_THEME_2);
    public static final Reservation JUNK_RESERVATION_3 = new Reservation(3L, "예약3", LocalDate.of(2025, 5, 4), JUNK_TIME_SLOT_3, JUNK_THEME_2);
    public static final Reservation JUNK_RESERVATION_4 = new Reservation(4L, "예약4", LocalDate.of(2025, 5, 4), JUNK_TIME_SLOT_1, JUNK_THEME_1);
    public static final Reservation JUNK_RESERVATION_5 = new Reservation(5L, "예약5", LocalDate.of(2025, 5, 5), JUNK_TIME_SLOT_2, JUNK_THEME_3);
    public static final Reservation JUNK_RESERVATION_6 = new Reservation(6L, "예약6", LocalDate.of(2025, 5, 5), JUNK_TIME_SLOT_3, JUNK_THEME_3);
    ...
    public static final Reservation JUNK_RESERVATION = new Reservation(7L, "예약", LocalDate.of(2025, 5, 6), JUNK_TIME_SLOT_1, JUNK_THEME_1);
