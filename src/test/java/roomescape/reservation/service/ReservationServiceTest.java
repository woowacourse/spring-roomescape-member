...
class ReservationServiceTest {
    ...
    void test1() {
        ...
        Reservation saved = new Reservation(1L, "미미", date, time, theme);
    ...
    void test4() {
        ...
        Reservation reservation = new Reservation(1L, "미미", LocalDate.of(2025, 5, 1), time, theme);
        ...
        assertThat(result.get(0).name()).isEqualTo("미미");
    }
