...
//
//        List<Reservation3> reservations = RestAssured.given().log().all()
//                .when().get("/reservations")
//                .then().log().all()
//                .statusCode(200).extract()
//                .jsonPath().getList(".", Reservation3.class);
//
...
//    ReservationRequest3 reservationRequest(String name, String date, long timeId, long themeId) {
//        return new ReservationRequest3(name, LocalDate.parse(date), timeId, themeId);
//    }
