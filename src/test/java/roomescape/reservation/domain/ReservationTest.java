...
class ReservationTest {
    ...
    private final ReservationTime reservationTime = ReservationTime.createWithId(1L, "15:46");
    ...
    void validateDateAndTimeExist() {
        ReservationTime reservationTime = ReservationTime.createWithId(1L, "15:46");

        assertAll(
                () -> assertThatThrownBy(() -> Reservation.createWithId(1L, "hotea", null, reservationTime, theme))
                        .isInstanceOf(NullPointerException.class),
                () -> assertThatThrownBy(() -> Reservation.createWithId(1L, "hotea", "2024-14-30", reservationTime, theme))
                        .isInstanceOf(DateTimeParseException.class),
                () -> assertThatThrownBy(() -> Reservation.createWithId(1L, "hotea", "2024-04-50", reservationTime, theme))
                        .isInstanceOf(DateTimeParseException.class)
        );
    }
}
