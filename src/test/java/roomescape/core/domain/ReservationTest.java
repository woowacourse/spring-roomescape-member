...
import static roomescape.util.Fixture.NAME;
...
class ReservationTest {
    ...
    void createReservation() {
        assertThatCode(() -> new Reservation(ID, NAME, DATE, RESERVATION_TIME, THEME))
    ...
    void throwExceptionWhenNullId() {
        assertThatThrownBy(() -> new Reservation(null, NAME, DATE, RESERVATION_TIME, THEME))
    ...
    void throwExceptionWhenEmptyDate(String emptyDate) {
        assertThatThrownBy(() -> new Reservation(ID, NAME, emptyDate, RESERVATION_TIME, THEME))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void throwExceptionWhenInvalidDateFormat() {
        assertThatThrownBy(() -> new Reservation(ID, NAME, "2024/5/5", RESERVATION_TIME, THEME))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void throwExceptionWhenNullReservationTime() {
        assertThatThrownBy(() -> new Reservation(ID, NAME, DATE, null, THEME))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void throwExceptionWhenNullTheme() {
        assertThatThrownBy(() -> new Reservation(ID, NAME, DATE, RESERVATION_TIME, null))
                .isInstanceOf(IllegalArgumentException.class)
