...
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('공포의 지하실', '지하실에서 탈출하세요.', 'https://example.com/basement.png');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('우주 정거장', '우주에서 살아남으세요.', 'https://example.com/space.png');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('탐정 사무소', '범인을 찾으세요.', 'https://example.com/detective.png');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('마법 학교', '마법을 배우고 탈출하세요.', 'https://example.com/magic.png');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('박물관이 살아있다', '밤의 박물관에서 탈출하세요.', 'https://example.com/museum.png');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('해적선', '보물을 찾고 탈출하세요.', 'https://example.com/pirate.png');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('미래 도시', '사이버펑크 세계관입니다.', 'https://example.com/cyberpunk.png');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('공룡 시대', '공룡들로부터 도망치세요.', 'https://example.com/dino.png');
INSERT INTO theme (name, description, thumbnail_url)
VALUES ('비밀의 정원', '아름답지만 위험한 정원입니다.', 'https://example.com/garden.png');
