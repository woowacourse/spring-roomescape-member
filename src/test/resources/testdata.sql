...
VALUES
    ('잉크', DATEADD('DAY', -5, CURRENT_DATE), 1, 1),
    ('잉크', DATEADD('DAY', -5, CURRENT_DATE), 2, 1),
    ('잉크', DATEADD('DAY', -4, CURRENT_DATE), 3, 2),
    ('뽀로로', DATEADD('DAY', -4, CURRENT_DATE), 4, 2),
    ('뽀로로', DATEADD('DAY', -3, CURRENT_DATE), 5, 3),
    ('뽀로로', DATEADD('DAY', -2, CURRENT_DATE), 6, 2),
    ('뽀로로', DATEADD('DAY', -1, CURRENT_DATE), 1, 2),
    ('뽀로로', DATEADD('DAY', -6, CURRENT_DATE), 1, 2);
