...
-- 1번 테마
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name1', '2024-04-29', '1', '1');
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name4', '2024-05-01', '5', '1');

-- 2번 테마
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name2', '2024-04-29', '2', '2');
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name3', '2024-04-30', '1', '2');
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name4', '2024-05-01', '5', '2');

-- 3번 테마
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name1', '2024-05-02', '1', '3');
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name1', '2024-05-03', '2', '3');
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name1', '2024-05-04', '3', '3');
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name1', '2024-05-02', '5', '3');

-- 4번 테마
INSERT INTO reservation(name, date, time_id, theme_id) VALUES ('name1', '2024-05-05', '4', '4');
