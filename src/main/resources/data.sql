...
VALUES
    -- theme_id = 1 (6회)
    ('Alice', '2025-05-07', 1, 1),
    ('Bob', '2025-05-07', 2, 1),
    ('Carol', '2025-05-07', 3, 1),
    ('Dave', '2025-05-07', 4, 1),
    ('Eve', '2025-05-07', 5, 1),
    ('Frank', '2025-05-07', 1, 1),

    -- theme_id = 2 (5회)
    ('Grace', '2025-05-07', 2, 2),
    ('Heidi', '2025-05-07', 3, 2),
    ('Ivan', '2025-05-07', 4, 2),
    ('Judy', '2025-05-07', 5, 2),
    ('Mallory', '2025-05-07', 1, 2),

    -- theme_id = 3 (4회)
    ('Niaj', '2025-05-07', 2, 3),
    ('Olivia', '2025-05-07', 3, 3),
    ('Peggy', '2025-05-07', 4, 3),
    ('Rupert', '2025-05-07', 5, 3),

    -- theme_id = 4 (3회)
    ('Sybil', '2025-05-07', 1, 4),
    ('Trent', '2025-05-07', 2, 4),
    ('Uma', '2025-05-07', 3, 4),

    -- theme_id = 5 (2회)
    ('Victor', '2025-05-07', 4, 5),
    ('Wendy', '2025-05-07', 5, 5),

    -- theme_id = 6 (1회)
    ('Xander', '2025-05-07', 1, 6),

    -- theme_id = 7 (1회)
    ('Yvonne', '2025-05-07', 2, 7),
    ...
    -- theme_id = 10 (1회)
    ('Brian', '2025-05-07', 5, 10),

    -- theme_id = 11 (1회)
    ('Chloe', '2025-05-07', 1, 11),

    -- theme_id = 12 (1회)
    ('Daniel', '2025-05-07', 2, 12);
