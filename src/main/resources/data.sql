...
VALUES
    ...
    -- theme_id = 3 (4회)
    ('2025-05-11', 2, 3, 13), -- Niaj
    ('2025-05-11', 3, 3, 14), -- Olivia
    ('2025-05-11', 4, 3, 15), -- Peggy
    ('2025-05-11', 5, 3, 16), -- Rupert

    -- theme_id = 4 (3회)
    ('2025-05-11', 1, 4, 17), -- Sybil
    ('2025-05-11', 2, 4, 18), -- Trent
    ('2025-05-11', 3, 4, 19), -- Uma

    -- theme_id = 5 (2회)
    ('2025-05-11', 4, 5, 20), -- Victor
    ('2025-05-11', 5, 5, 21), -- Wendy

    -- theme_id = 6 (1회)
    ('2025-05-11', 1, 6, 22), -- Xander

    -- theme_id = 7 (1회)
    ('2025-05-11', 2, 7, 23), -- Yvonne

    -- theme_id = 8 (1회)
    ('2025-05-11', 3, 8, 24), -- Zack

    -- theme_id = 9 (1회)
    ('2025-05-11', 4, 9, 25), -- Amy

    -- theme_id = 10 (1회)
    ('2025-05-11', 5, 10, 26), -- Brian

    -- theme_id = 11 (1회)
    ('2025-05-11', 1, 11, 27), -- Chloe

    -- theme_id = 12 (1회)
    ('2025-05-11', 2, 12, 28); -- Daniel
