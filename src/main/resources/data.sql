...
VALUES ('브라운', DATEADD(DAY, -7, current_date), 1, 8),
       ('엘라', DATEADD(DAY, -1, current_date), 2, 7),
       ('릴리', DATEADD(DAY, -7, current_date), 2, 7),
