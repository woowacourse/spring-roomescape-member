insert into member(name, email, password, role) values ('ash', 'test@email.com', '1234', 'ADMIN');
INSERT INTO member(name,email,password,role) VALUES('dominic','test2@email.com','1234', 'USER');
