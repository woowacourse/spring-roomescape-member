...
MERGE INTO theme(name, description, thumbnail) KEY (name, description, thumbnail) VALUES
    ...
    ('녹화된 마지막 하루', '누군가의 마지막 하루를 되돌려 탈출해야 한다.', 'src/main/resources/static/images/themes/4.png'),
    ('VIP 전용 금고', '제한 시간 내 금고를 열지 못하면 시스템이 초기화된다.', 'src/main/resources/static/images/themes/5.png');