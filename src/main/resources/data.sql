...
VALUES
    (1, '브라운', DATE '2026-05-05', 1),
    (2, '코니', DATE '2026-05-04', 1),
    (3, '샐리', DATE '2026-05-03', 2),
    (4, '문', DATE '2026-05-02', 2),
    (5, '제시카', DATE '2026-05-01', 1),

    (6, '제임스', DATE '2026-05-05', 3),
    (7, '레오', DATE '2026-05-04', 3),
    (8, '루카', DATE '2026-05-03', 4),
    (9, '앤디', DATE '2026-05-02', 4),

    (10, '레너드', DATE '2026-05-05', 5),
    (11, '초코', DATE '2026-05-04', 5),
    (12, '브이', DATE '2026-05-03', 5),

    (13, '에디', DATE '2026-05-05', 6),
    (14, '리아', DATE '2026-05-04', 6),

    (15, '마크', DATE '2026-05-05', 7),
    (16, '니나', DATE '2026-05-04', 7),

    (17, '제이', DATE '2026-05-05', 8),
    (18, '하나', DATE '2026-05-05', 9),
    (19, '오웬', DATE '2026-05-05', 10),
    (20, '소라', DATE '2026-05-05', 11),
    (21, '태오', DATE '2026-05-05', 12),

    (22, '미래예약1', DATE '2026-05-12', 1),
    (23, '미래예약2', DATE '2026-05-12', 3);
