...
function applyFilter(event) {
  ...
  const themeQueryString = themeId == ''? '' : 'theme_id=' + themeId;
  const memberQueryString = memberId == ''? '' : 'member_id=' + memberId;
  const dateFromQueryString = dateFrom == ''? '' : 'dateFrom=' + dateFrom;
  const dateToQueryString = dateTo == ''? '' : 'dateTo=' + dateTo;

  const queryString = themeQueryString + '&' + memberQueryString + '&' + dateFromQueryString + '&' + dateToQueryString;
