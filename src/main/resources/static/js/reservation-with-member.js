...
function render(data) {
    ...
    data.forEach(item => {
        ...
        */
        ...
        // row.insertCell(1).textContent = item.member.name;     // 사용자 name TODO: 이렇게 dto 속성을 바꿔볼꺄?
...
function applyFilter(event) {
    ...
    TODO: [6단계] 예약 검색 - 조건에 따른 예약 조회 API 호출
          요청 포맷에 맞게 설정
    */
    fetch('/admin/reservations?memberId=' + memberId + '&themeId=' + themeId + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo, { // 예약 검색 API 호출
        method: 'GET',
        headers: {
