...
public enum ErrorCode {
    ...
    NAME_MUST_NOT_BE_NULL("이름은 필수로 입력해야 합니다.", HttpStatus.BAD_REQUEST),
    ...
    PAST_RESERVATION_NOT_ALLOWED("과거 예약 생성은 불가능합니다. 오늘 이후 날짜와 시간으로 다시 시도해 주세요", HttpStatus.UNPROCESSABLE_ENTITY);
