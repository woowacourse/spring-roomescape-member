...
public class ReservationTimeController {
    ...
    public ResponseEntity<Response> getAvailableReservationTimeByDateAndTheme(@ModelAttribute AvailableReservationTimeRequest availableReservationTimeRequest) {
