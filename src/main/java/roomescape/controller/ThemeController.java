...
public class ThemeController {
    ...
    @PostMapping
    public ResponseEntity<ThemeResponse> createTheme(@RequestBody ThemeCreationRequest request) {
    ...
    public ResponseEntity<Void> deleteById(@PathVariable("themeId") long id) {
