...
import roomescape.controller.dto.ControllerThemeRequest;
import roomescape.controller.dto.ControllerThemeResponse;
...
public class AdminThemeController {
    ...
    @PostMapping
    public ResponseEntity<ControllerThemeResponse> create(@Valid @RequestBody ControllerThemeRequest requestDto) {
