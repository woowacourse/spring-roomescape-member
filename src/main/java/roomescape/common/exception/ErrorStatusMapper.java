...
public class ErrorStatusMapper {
    ...
    static {
        ...
        statusByErrorCode.put(ErrorCode.RESERVATION_ALREADY_HAS_ID, HttpStatus.CONFLICT);
        statusByErrorCode.put(ErrorCode.RESERVATION_ALREADY_EXISTS, HttpStatus.CONFLICT);
        statusByErrorCode.put(ErrorCode.RESERVATION_TIME_ALREADY_HAS_ID, HttpStatus.CONFLICT);
        statusByErrorCode.put(ErrorCode.RESERVATION_TIME_ALREADY_EXISTS, HttpStatus.CONFLICT);
        statusByErrorCode.put(ErrorCode.RESERVATION_TIME_HAS_RESERVATION, HttpStatus.CONFLICT);
        statusByErrorCode.put(ErrorCode.THEME_ALREADY_HAS_ID, HttpStatus.CONFLICT);
        statusByErrorCode.put(ErrorCode.THEME_HAS_RESERVATION, HttpStatus.CONFLICT);
