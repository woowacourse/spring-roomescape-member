...
public class ReservationRepository {
    ...
    public List<Reservation> findAllWithCondition(
        ...
        DynamicReservationSelectQuery dynamicReservationSelectQuery = new DynamicReservationSelectQuery(jdbcTemplate);
        dynamicReservationSelectQuery.addMemberCondition(memberId);
        dynamicReservationSelectQuery.addThemeCondition(themeId);
        dynamicReservationSelectQuery.addFromDateCondition(fromDate);
        dynamicReservationSelectQuery.toEndDateCondition(toDate);
        return dynamicReservationSelectQuery.findAllReservations();
    }
}
