...
public class ReservationDao {
    ...
    public Optional<Reservation> findById(long id) {
        try {
            String sql = """
                    SELECT 
                          r.id AS reservation_id, r.name, r.date, time.id AS time_id, time.start_at AS time_value 
                        theme.id AS theme_id, theme.name AS theme_name, theme.descrption, theme.thumbnail 
