...
public record ReservationDataWithTimeAndTheme(long id, String name, LocalDate date, ReservationTime time, Theme reservationTheme) {
    ...
    public ReservationDataWithTimeAndTheme {
        validateName(name);
        validateDateValue(date);
        validateObjects(time, reservationTheme);
    }

    public ReservationDataWithTimeAndTheme(long id, String name, String date, ReservationTime time, Theme theme) {
