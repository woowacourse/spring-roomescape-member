...
public record ReservationWithTimeAndTheme(long id, String name, LocalDate date, ReservationTime time, Theme reservationTheme) {
    ...
    public ReservationWithTimeAndTheme {
        validateName(name);
        validateDateValue(date);
        validateObjects(time, reservationTheme);
    }

    public ReservationWithTimeAndTheme(long id, String name, String date, ReservationTime time, Theme theme) {
