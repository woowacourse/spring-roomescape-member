...
public class ReservationRepository {
    ...
    public List<Reservation> findAll() {
        String sql = getReservationSelectQuery();
    ...
    public Optional<Reservation> findById(Long id) {
        String sql = getReservationSelectQuery() + " WHERE r.id = ?";
        try {
            Reservation reservation = jdbcTemplate.queryForObject(sql, this::mapToReservation, id);
    ...
    private Reservation mapToReservation(ResultSet resultSet, int rowNum) throws SQLException {
        ...
        Theme theme = new Theme(
                ...
                resultSet.getObject("theme_required_time", LocalTime.class)
        );
    ...
    private String getReservationSelectQuery() {
        return """
