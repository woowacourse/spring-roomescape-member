...
public enum ErrorCode {
    ...
    THEME_NOT_FOUND(HttpStatus.NOT_FOUND, "THEME_NOT_FOUND"),
    RESERVATION_TIME_NOT_FOUND(HttpStatus.NOT_FOUND, "RESERVATION_TIME_NOT_FOUND"),
    DUPLICATE_RESERVATION(HttpStatus.CONFLICT, "DUPLICATE_RESERVATION"),
    ...
    INVALID_RESERVATION_TIME(HttpStatus.BAD_REQUEST, "INVALID_RESERVATION_TIME"),
    INVALID_THEME(HttpStatus.BAD_REQUEST, "INVALID_THEME"),
