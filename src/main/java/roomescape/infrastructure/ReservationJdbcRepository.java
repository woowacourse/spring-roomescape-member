...
public class ReservationJdbcRepository implements ReservationRepository {
    ...
    private static final String selectAndJoinFragment = """
        select R.id,
    ...
    public Optional<Reservation> findById(final long id) {
        var sql = selectAndJoinFragment + "where R.id = ?";
    ...
    public Optional<Reservation> findByDateAndTimeSlotAndThemeId(final LocalDate date, final long timeSlotId, final long themeId) {
        var sql = selectAndJoinFragment + "where R.date = ? AND R.time_id = ? AND R.theme_id = ?";
