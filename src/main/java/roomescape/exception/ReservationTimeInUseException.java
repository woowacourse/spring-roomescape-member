...
public class ReservationTimeInUseException extends BusinessException {
    ...
    private static final String CLIENT_DETAIL = "해당 시간에 이미 잡혀있는 예약이 존재하여 시간 정보를 삭제할 수 없습니다. 관련된 예약을 먼저 정리해 주세요.";

    public ReservationTimeInUseException(String logMessage) {
        super(logMessage);
    }
