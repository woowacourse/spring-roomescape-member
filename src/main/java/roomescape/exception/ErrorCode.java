...
public enum ErrorCode {
    ...
    RESERVATION_NOT_USER_CANCEL(HttpStatus.UNPROCESSABLE_ENTITY, "다른 사용자의 예약을 취소할 수 없습니다."),
    RESERVATION_PAST_UPDATE(HttpStatus.UNPROCESSABLE_ENTITY, "이미 지난 예약은 변경할 수 없습니다."),
    RESERVATION_PAST_CANCEL(HttpStatus.UNPROCESSABLE_ENTITY, "이미 지난 예약은 취소할 수 없습니다."),
    ...
    RESERVATION_NAME_TOO_LONG(HttpStatus.BAD_REQUEST, "예약자 이름은 20자 이하여야 합니다."),
