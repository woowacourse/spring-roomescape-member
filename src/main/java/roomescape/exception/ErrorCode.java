...
public enum ErrorCode {
    ...
    RESERVATION_UPDATE_FAILED(HttpStatus.CONFLICT, "예약 변경에 실패했습니다. 본인의 예약이 맞는지, 또는 취소된 예약인지 다시 확인해 주세요."),
    ...
    SCHEDULE_IN_USE(HttpStatus.CONFLICT, "해당 스케줄에 예약이 존재하여 삭제할 수 없습니다. 예약을 먼저 처리해주세요."),
