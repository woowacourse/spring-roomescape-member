...
public enum ErrorCode {
    ...
    THEME_HAS_RESERVATIONS(HttpStatus.UNPROCESSABLE_ENTITY, "예약이 존재하는 테마는 삭제할 수 없습니다.", null),
    ...
    TIME_HAS_RESERVATIONS(HttpStatus.UNPROCESSABLE_ENTITY, "예약이 존재하는 시간은 삭제할 수 없습니다..", null),
    ...
    RESERVATION_NOT_USER_CANCEL(HttpStatus.UNPROCESSABLE_ENTITY, "다른 사용자의 예약을 취소할 수 없습니다.", null),
