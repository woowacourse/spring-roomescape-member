...
public enum ErrorCode {
    ...
    RESERVATION_DELETE_FAILED("RESERVATION_DELETE_500", "서버 내부 오류가 발생하였습니다. 잠시 후에 다시 시도해 주세요."),
    RESERVATION_UPDATE_EMPTY("RESERVATION_400", "수정할 예약 정보가 없습니다."),
    RESERVATION_UPDATE_FAILED("RESERVATION_UPDATE_500", "서버 내부 오류가 발생하였습니다. 잠시 후에 다시 시도해 주세요."),
    ...
    SCHEDULE_DELETE_FAILED("SCHEDULE_500", "서버 내부 오류가 발생하였습니다. 잠시 후에 다시 시도해 주세요."),
    ...
    PAST_SCHEDULE("PAST_SCHEDULE_400","이미 지난 날짜/시간으로는 처리할 수 없습니다."),
