...
public enum BadRequestCode implements ErrorCode {
    INVALID_REQUEST("요청 값이 유효하지 않습니다.", "요청 값을 확인 후 다시 시도해주세요."),
    VALIDATION_FAILED("요청 형식이 올바르지 않습니다.", "요청 값을 확인 후 다시 시도해주세요."),
    INVALID_RESERVATION_NAME("유효하지 않은 이름입니다.", "이름을 다시 확인해주세요."),
    BLANK_RESERVATION_NAME("이름은 공백일 수 없습니다.", "이름을 다시 확인해주세요."),
    INVALID_RESERVATION_DATE("유효하지 않은 날짜입니다.", "날짜를 다시 확인해주세요."),
