...
public enum ErrorCode {
    ...
    UNAUTHORIZED_RESERVATION_ACCESS(UNAUTHORIZED, "UNAUTHORIZED_RESERVATION_ACCESS", "본인의 예약만 접근 가능합니다."),

    // theme
    NOT_FOUND_THEME(NOT_FOUND, "NOT_FOUND_THEME", "존재하지 않는 테마입니다."),
    ...
    // reservationTime
    NOT_FOUND_RESERVATION_TIME(NOT_FOUND, "NOT_FOUND_RESERVATION_TIME", "존재하지 않는 예약 시간입니다."),
